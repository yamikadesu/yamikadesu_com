...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style2', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#table01', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text12', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text14', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#list01', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text11', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text13', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text10', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
		onvisible.add('#text08', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, state: true, replay: false });
